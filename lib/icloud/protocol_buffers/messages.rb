...
module Icloud
  module ProtocolBuffers
    ...
    class Backup < ::ProtocolBuffers::Message
      ...
      required ::Icloud::ProtocolBuffers::DeviceInfo, :device_info, 5
    ...
    class Backups < ::ProtocolBuffers::Message
      ...
      repeated ::Icloud::ProtocolBuffers::Backup, :backup, 3
      required ::Icloud::ProtocolBuffers::DeviceType, :device_type, 4
    ...
    class FileInfo < ::ProtocolBuffers::Message
      ...
      repeated ::Icloud::ProtocolBuffers::FileAttribute, :attributes, 13
    ...
    class File < ::ProtocolBuffers::Message
      ...
      optional ::Icloud::ProtocolBuffers::FileInfo, :fileinfo, 6
    ...
    class Keys < ::ProtocolBuffers::Message
      repeated ::Icloud::ProtocolBuffers::Key, :keySet, 1
    end
    ...
    class GetAuthorizeGetRequest < ::ProtocolBuffers::Message
      required :hex, :hash, 1
      required :string, :key, 2
    end
  end
